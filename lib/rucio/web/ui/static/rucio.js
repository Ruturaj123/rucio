...
/* check if current token is expired and, if necessary, request a new one */
...
// RucioClient.prototype.validate_credentials = function(options) {
//     var url =  'https://' + window.location.host +'/ui/login';
